...
{
private:
    const std::string m_fileName = "lesous.ini";
    ...
    int m_aimbotSmoothing = 100;
    int m_aimbotActivationFOV = 30;
    int m_aimbotMaxRange = 300;

    // norecoil
    double m_norecoilPitchStrength = 0.5;
    double m_norecoilYawStrength = 0.5;
